...
class CaseDelete extends Command
{


    private $action = 'Delete';
    private $stubPath = '/../../resources/stubs/case.delete.stub';
     ...
     * @var string
     */
    protected $signature = 'module:case-delete {name}';
     ...
     * @var string
     */
    protected $description = 'Create a new case for delete use case';
