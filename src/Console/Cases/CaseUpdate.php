...
class CaseUpdate extends Command
{

    private  $action = 'Update';
    private $stubPath = '/../../resources/stubs/case.update.stub';
     ...
     * @var string
     */
    protected $signature = 'module:case-update {name}';
     ...
     * @var string
     */
    protected $description = 'Create a new case for update use case';
