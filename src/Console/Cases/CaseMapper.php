...
class CaseMapper extends Command
{

    private $stubPath = '/../../resources/stubs/case.mapper.stub';
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'module:case-mapper {name : Case mapper for use cases}';
     ...
     * @var string
     */
    protected $description = 'Create a new resolver for use cases';
