...
class CaseCreate extends Command
{

    private $action = 'Create';
    private $stubPath = '/../../resources/stubs/case.create.stub';
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'module:case-create {name}';
     ...
     * @var string
     */
    protected $description = 'Create a new case for create use case';
