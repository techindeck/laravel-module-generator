...
class CaseFind extends Command
{

    private  $action = 'Find';

    private $stubPath = '/../../resources/stubs/case.find.stub';
     ...
     * @var string
     */
    protected $signature = 'module:case-find {name}';
     ...
     * @var string
     */
    protected $description = 'Create a new case for find use case';
