...
namespace Techindeck\LaravelModuleGenerator\Console\Repo;
...
class RepoCommand extends Command
{
    ...
    private $stubPath = '/../../resources/stubs/repository.stub';
     ...
     * @var string
     */
    protected $signature = 'module:repository {name : name of the repository}';
     ...
     * @var string
     */
    protected $description = 'Make a repository for a specified module';
