...
class ControllerCreate extends Command
{
    ...
    private $stubPath = '/../../resources/stubs/controller.create.stub';
     ...
     * @var string
     */
    protected $signature = 'module:controller-create {name : name of case controller}';
     ...
     * @var string
     */
    protected $description = 'Create a new controller for case create';
